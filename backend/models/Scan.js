...
const threatIntelligenceSchema = new mongoose.Schema({
  status: { type: String, default: "Unclassified" },
  confidence: { type: Number, default: 0, min: 0, max: 100 },
  campaignId: { type: String, default: "" },
  threatType: { type: String, default: "" },
  target: { type: String, default: "" },
  description: { type: String, default: "" },
  previousMatches: { type: Number, default: 0, min: 0 },
...
const scanSchema = new mongoose.Schema({
  ...
  urlAnalysis: {
    ...
    risk: { type: Number, default: 0, min: 0, max: 60 },
  },
  impersonation: { type: mongoose.Schema.Types.Mixed, default: null },
  categoryAnalysis: { type: mongoose.Schema.Types.Mixed, default: null },
  campaignAnalysis: {
    type: campaignAnalysisSchema,
    default: () => ({ detected: false, campaignId: "", label: "", confidence: 0, matchedTactics: [], explanation: "" }),
  },
  threatIntelligence: {
    type: threatIntelligenceSchema,
    default: () => ({ status: "Unclassified", confidence: 0, campaignId: "", threatType: "", target: "", description: "", previousMatches: 0, source: "", explanation: "" }),
  },
  riskSummary: { type: String, required: true },
  recommendation: { type: String, required: true },
  protectionActions: { type: [String], default: [] },
}, { timestamps: true });
